...
export default function (context) {
    ...
    function loadProductByCategory() {
        ...
        var customProductBlock = $(
            '.product-by-category [data-custom-products-by-category-tabs]'
        );
    ...
    function formatDateString(inputDate) {
        ...
        const formattedMonth = dateObject
    ...
    function formatDateBlogPost() {
        let homeBlogPosts = document.querySelectorAll(
            '.home-layout-custom .halo-block-post .item .date'
        );
